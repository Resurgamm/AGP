...
async def main():
    ...
    result_dir = Path(f"{AGP_ROOT}/result/eval")
    ...
    for i_batch in range(num_batches):
        ...
        for task, answer, log_prob, test, mask, edge_weight in zip(current_batch, raw_answers, log_probs, tests, masks, edge_weights):
            ...
            if is_solved:
                ...
                with open("train_coding.json", "a", encoding="utf-8") as f:
